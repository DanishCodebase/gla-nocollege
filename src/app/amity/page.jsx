...
const AmityPage = () => {
  return (
    <section
      className="py-16 px-4 bg-white relative h-[calc(100vh-72px)] bg-cover bg-center bg-no-repeat z-0"
      style={{
    ...
    >
      ...
      <div className="max-w-7xl px-4 mx-auto h-full flex items-center relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center w-full">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-white text-6xl font-bold">Online MBA</p>
            <div className="flex gap-8 mt-5 items-center">
              <button className="bg-gradient-to-r from-green-400 to-green-600 text-white px-10 py-2 rounded-md">
                Apply Now
              </button>
              <Image
      ...
      <div className="max-w-7xl px-4 mx-auto grid grid-cols-4 gap-4 relative z-20">
